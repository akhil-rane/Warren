    ...
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown profile">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">imDurgadas <span class="caret"></span></a>
                <ul class="dropdown-menu animated fadeInDown">
                    ...
                    <li>
                        <div class="profile-info">
                            <h4 class="username">Durgadas Kamath</h4>
                            <p>durgadasthegenius@gmail.com</p>
